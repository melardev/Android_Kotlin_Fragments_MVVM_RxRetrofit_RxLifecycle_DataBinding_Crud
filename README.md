...
# Introduction
Android application implementing a basic CRUD operation using MVVM + Reactive Bindings for Retrofit + Lifecycle with ReactiveJava +  Data Binding.<br>
The project tries to use Fragments.
The project has to be improved a little bit, but for the most part it is almost complete.
...
- [Android Kotlin MVVM + Dagger + Rx Retrofit + Data Binding](https://github.com/melardev/Android_Kotlin_MVVM_Dagger_RxRetrofit_DataBinding_Crud)
- [Android Kotlin + Fragments + MVVM + Rx Retrofit + Lifecycle with Reactive Java + Data Binding](https://github.com/melardev/Android_Kotlin_Fragments_MVVM_RxRetrofit_RxLifecycle_DataBinding_Crud)
